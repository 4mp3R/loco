...
class Application_Model_Acl extends Zend_Acl {
    ...
    public function __construct() {
        ...
        $this->addRole(new Zend_Acl_Role("lessee"), "unregistered")
            ...
            ->allow("lessee", array(
                "accomodation_get", "accomodation_option", "accomodation_search", "contract_index", "contract_view",
        ...
        $this->addRole(new Zend_Acl_Role("admin"), "lesser")
            ...
            ->allow("admin", array(
                "accomodation_view-all", "accomodation_type-manage", "loco_settings", "loco_statistics", "loco_faq-edit", "loco_faq-modify", "loco_faq-delete", "user_view-all", "user_delete"
            ));
    }
